...
export default function AdminLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        // Valid for 2 hours
        localStorage.setItem("shop_admin_expiry", (Date.now() + 2 * 60 * 60 * 1000).toString());
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "var(--color-bg-primary)" }}>
      <div style={{ width: "100%", maxWidth: "400px", padding: "40px", border: "4px solid var(--color-text-primary)", backgroundColor: "var(--color-bg-primary)", boxShadow: "8px 8px 0 var(--color-text-primary)" }}>
          ...
          <div>
            ...
            <input
              ...
              style={{
                ...
                border: "2px solid var(--color-text-primary)", backgroundColor: "var(--color-bg-primary)",
